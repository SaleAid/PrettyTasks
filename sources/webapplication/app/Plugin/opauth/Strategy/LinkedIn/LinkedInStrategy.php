...
class LinkedInStrategy extends OpauthStrategy{
	...
	public $defaults = array(
		...
		'profile_fields' => array('id', 'first-name', 'last-name', 'formatted-name', 'headline', 'picture-url', 'summary', 'email-address', 'location', 'public-profile-url', 'site-standard-profile-request'),
