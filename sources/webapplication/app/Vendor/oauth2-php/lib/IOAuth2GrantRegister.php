...
/**
 * Storage engines that support the "Google Credentials"
 ...
 */
interface IOAuth2GrantRegister extends IOAuth2Storage {

	/**
	 * Required for OAuth2::GRANT_TYPE_GOOGLE.
	 *
	 * @param $user_id
	 * User identifier to be check with.
	 * @param $client_secret
