    ...
    <div class="span10 offset1">
        ...
        'inputDefaults' => array(
        	...
        	<fieldset>
            	...
            	<?php echo $this->Form->input('User.username',array('label' =>'Логин:', 'class' => 'input-xlarge')); ?>
                
            	<?php echo $this->Form->input('User.first_name',array('label' =>'Имя:', 'class' => 'input-xlarge')); ?>
