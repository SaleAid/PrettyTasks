...
<ul class="share-entry">
    <li><a class="share share-twitter" title="<?php echo __d('pages', 'Share on Twitter'); ?>" href="http://twitter.com/share?text=<?php echo $text; ?>&url=<?php echo $url; ?>"><?php echo __d('pages', 'Share on'); ?> <?php echo $this->Loginza->ico('twitter'); ?>&nbsp;<?php echo __d('pages', 'Twitter'); ?> </a></li>
