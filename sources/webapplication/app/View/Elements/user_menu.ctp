<div class="span3">
  <div class="well sidebar-nav">
    <ul class="nav nav-pills nav-stacked">
      <li class="nav-header"><?php echo __('Мой профиль');?></li>
      ...
      <li class="nav-header"><?php echo __('Дополнительно');?></li>
      </li>
            ...
            <?php echo $this->Html->link(__('Обратная связь'). $this->Html->tag('i', '',array('class' => 'icon-chevron-right pull-right')), array('controller' => 'feedbacks', 'action' => 'add'),array('escape' => false)); ?>
      </li>
    </ul>
  </div>
</div>