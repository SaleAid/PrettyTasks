  ...
  <div class="well sidebar-nav">
    <ul class="nav nav-pills nav-stacked">
      ...
      <li class="<? if($this->params['action'] == "password_change") echo 'active'; ?>">
            <?php echo $this->Html->link(__d('users', 'Изменить пароль'). $this->Html->tag('i', '', array('class' => 'icon-chevron-right pull-right')), array('controller' => 'users', 'action' => 'password_change'), array('escape' => false)); ?>
      </li>
