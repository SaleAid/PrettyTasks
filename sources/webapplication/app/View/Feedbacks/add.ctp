...
<div class="row">
    ...
    <div class="span4 message">
        <div class="note">
            <h3>Сообщение</h3>
            <p>Ваше мнение очень важно для нас. <br/>
            Пожалуйста, опишите Вашу просьбу, проблему как можно более подробно, чтобы мы могли быстрее и полнее ее проработать. <br/>
            Спасибо за сотрудничество. <br/>
            Мы делаем все, чтобы наш сервис приносил Вам наибольшую пользу и комфорт.</p>
