...
/* Webkit Elements */
#top-bar { border-radius:6px 6px 0px 0px; -moz-border-radius: 6px 6px 0px 0px; -webkit-border-radius:6px 6px 0px 0px; -webkit-font-smoothing: antialiased; background-color: #c7c7c7; color: #ebddeb; }
...
.header-content { font-size: 12px; color: #ebddeb; }
...
.article-title { font-size: 18px; line-height:24px; color: #4f4d4f; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif; }
.article-title a { color: #4f4d4f; text-decoration: none; }
