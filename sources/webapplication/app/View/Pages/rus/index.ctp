<?php
 ...
 ?>
<div class="start">
  <?php echo $this->Html->image('comics_ru.'. Configure::read('App.version') .'.jpg', array('width' => 970, 'height' =>355)); ?>
</div>
<div class="row">
	...
	<div class="span4 box right">
        ...
        <div class="box_container">  
            ...
            <p> 
             ...
             <?php echo $this->Html->link(__('Пли!'),array('controller' => 'users', 'action' => 'login'),array('class'=> 'btn btn-large btn-block btn btn-success fire')); ?>
        </div>
	</div>
</div>
